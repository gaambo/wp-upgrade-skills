...
7. Start with the most relevant release-note files only.
...
- Only read remaining files when the repo indicates impact.
...
- `release-notes/breaking-changes.md` - Breaking Changes
- `release-notes/deprecated.md` - Deprecated
- `release-notes/core-api.md` - Core API
- `release-notes/editor.md` - Editor
- `release-notes/frontend.md` - Frontend
- `release-notes/admin.md` - Admin
- `release-notes/database.md` - Database
- `release-notes/performance.md` - Performance
- `release-notes/tooling.md` - Tooling
...
- Include source URLs from the release-note entries when helpful.
