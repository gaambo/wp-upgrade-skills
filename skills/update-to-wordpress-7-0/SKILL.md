---
name: update-to-wordpress-7-0
description: Audit a codebase for WordPress 7.0 upgrade risks using focused, release-specific notes.
---

# Update to WordPress 7.0

Use this skill when a user needs an upgrade audit, migration plan, or compatibility review for WordPress 7.0.
...
5. If local WP environment tooling exists, include required version bump steps for WordPress 7.0.
